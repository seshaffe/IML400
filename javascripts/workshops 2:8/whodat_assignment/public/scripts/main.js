...
var $Lwing1 = getElementsByClassName("wing_L");
$Lwing1.setAttribute(color, red);
...
var $cage3 = getElementsByClassName("cage column-4");
$cage.setAttribute(color, green);
...
var $beak = getElementsByCalssName("beak");
$beak.setAttribute(size, 90px);
...
function getCage(cageNumber) {
	...
	var selectedCage = getElementsByClassName("cage");
	var selectedCage = mouseclick("cage");
...
var $column = getElementsByClassName("column");
